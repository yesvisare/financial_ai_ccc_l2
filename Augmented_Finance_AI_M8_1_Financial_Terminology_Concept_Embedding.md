...
**Track:** Finance AI  
**Level:** L1 SkillLaunch (Domain Track)  
**Audience:** RAG Engineers in financial services who completed Generic CCC M1-M6 and Finance AI M7  
**Prerequisites:** 
...
**NARRATION:**
"You've built a solid RAG system through Modules M1-M6. In Module M7, you learned to ingest SEC filings, handle PII redaction, and maintain compliance audit trails. Your system can parse 10-K documents, extract financial tables, and track document provenance.
